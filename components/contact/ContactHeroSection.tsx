...
export function ContactHeroSection({ socials }: ContactHeroSectionProps) {
  return (
    <section className="relative flex min-h-[45vh] flex-col justify-center overflow-hidden border-b border-[var(--surface-border)] bg-[var(--background)] py-20">
      ...
      <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_bottom_right,rgba(0,255,204,0.06),transparent_50%)] pointer-events-none" />
      ...
      <Container className="relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="max-w-xl font-body text-base leading-relaxed text-[var(--muted)] border-l-2 border-[var(--surface-border)] pl-4">
            {socials.contactMessage.description}
          </p>
        </div>
      </Container>
    </section>
